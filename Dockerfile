...
# Use Render's PORT env variable. Using 4 threads prevents long face-scans from blocking other quick API requests.
CMD ["sh", "-c", "gunicorn --bind 0.0.0.0:${PORT:-10000} --timeout 120 --workers 1 --threads 4 app:app"]
